    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <a 
            href="https://www.instagram.com/snaild.it/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center space-x-2 bg-white border border-gray-200 hover:border-lime-300 text-gray-700 hover:text-lime-600 px-6 py-3 rounded-full transition-colors shadow-sm hover:shadow-md"
          >
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-lime-600 mb-2">100%</div>
              <div className="text-gray-600">Business Converting</div>
            </div>
            <div>
